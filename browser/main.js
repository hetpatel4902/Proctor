...
//       //   disableBlinkFeatures: "Auxclick", // Remove this line if it's not necessary
//     },
//   });

//   win.on("beforeunload", (e) => {
//     console.log("beforeunload event handler executed");
...
//   return win;
// }
// // Register a global shortcut for the Windows key

// app.whenReady().then(() => {
//   const mainWindow = createWindow();
//   console.log("hello");
//   // Register a global shortcut for the Windows key (e.g., "CommandOrControl+Shift+W")
//   //   const windowsKeyShortcut = "CommandOrControl+Shift+W";
//   //   globalShortcut.register(windowsKeyShortcut, () => {
//   //     // Handle the Windows keypress event here
//   //     // You can leave this callback empty to effectively block the keypress
//   //     console.log("don't press windows key");
//   //   });
//   //   globalShortcut.register("Super", () => {
//   //     // Do something to prevent the default behavior of the Windows key
//   //     console.log("dont press me");
//   //   });

//   // Unregister the global shortcut when your app quits
//   //   app.on("will-quit", () => {
    ...
    if (error) {
      ...
      if (process.platform === "win32" || process.platform === "darwin") {
        ...
        const pythonScriptPath = path.resolve(
          "C:/Users/hetvr/browser/blockalttab.py"
        );
