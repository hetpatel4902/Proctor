...
(function () {
  ...
  jQuery.fn.extend({
    imagepicker: function (e) {
      return (
        ...
        this.each(function () {
          ...
          return (
            (i = jQuery(this)),
            i.data("picker") && i.data("picker").destroy(),
            i.data("picker", new t(this, s(e))),
            null != e.initialized
              ? e.initialized.call(i.data("picker"))
              : void 0
          );
        })
      );
    ...
    (t = (function () {
      function t(t, e) {
        (this.opts = null != e ? e : {}),
          (this.sync_picker_with_select = l(
      ...
      return (
        (t.prototype.destroy = function () {
          var t, e, i, s;
          for (s = this.picker_options, e = 0, i = s.length; i > e; e++)
            (t = s[e]), t.destroy();
          return (
            this.picker.remove(),
        ...
        (t.prototype.sync_picker_with_select = function () {
          var t, e, i, s, l;
          for (s = this.picker_options, l = [], e = 0, i = s.length; i > e; e++)
            (t = s[e]),
              t.is_selected()
                ? l.push(t.mark_as_selected())
                : l.push(t.unmark_as_selected());
          return l;
        }),
        ...
        (t.prototype.recursively_parse_option_groups = function (t, i) {
          ...
          for (a = t.children("optgroup"), r = 0, o = a.length; o > r; r++)
            (n = a[r]),
              (n = jQuery(n)),
              (s = jQuery("<ul></ul>")),
              s.append(
                jQuery("<li class='group_title'>" + n.attr("label") + "</li>")
              ),
              i.append(jQuery("<li>").append(s)),
              this.recursively_parse_option_groups(n, s);
          for (
            p = function () {
              var i, s, n, r;
              for (
                n = t.children("option"), r = [], i = 0, s = n.length;
                s > i;
                i++
              )
                (l = n[i]), r.push(new e(l, this, this.opts));
              return r;
            }.call(this),
              u = [],
              c = 0,
        ...
        (t.prototype.has_implicit_blanks = function () {
          ...
          return (
            function () {
              var e, i, s, l;
              for (
                s = this.picker_options, l = [], e = 0, i = s.length;
                i > e;
                e++
              )
                (t = s[e]), t.is_blank() && !t.has_image() && l.push(t);
              return l;
            }.call(this).length > 0
          );
        }),
        ...
        (t.prototype.toggle = function (t) {
          ...
          return (
            ...
            (l = "" + t.value()),
            this.multiple
              ? n.call(this.selected_values(), l) >= 0
                ? ((e = this.selected_values()),
                  e.splice(jQuery.inArray(l, s), 1),
                  this.select.val([]),
                  this.select.val(e))
                ...
                : this.select.val(this.selected_values().concat(l))
              : this.has_implicit_blanks() && t.is_selected()
              ? this.select.val("")
              : this.select.val(l),
            i(s, this.selected_values()) ||
            (this.select.change(), null == this.opts.changed)
              ? void 0
              : this.opts.changed.call(this.select, s, this.selected_values())
          );
        }),
        t
      );
    ...
    (e = (function () {
      function t(t, e, i) {
        (this.picker = e),
          (this.opts = null != i ? i : {}),
          (this.clicked = l(this.clicked, this)),
      ...
      return (
        ...
        (t.prototype.is_selected = function () {
          var t;
          return (
            (t = this.picker.select.val()),
            this.picker.multiple
              ? jQuery.inArray(this.value(), t) >= 0
              : this.value() === t
          );
        }),
        ...
        (t.prototype.clicked = function () {
          return (
            ...
            null != this.opts.selected && this.is_selected()
              ? this.opts.selected.call(this.picker.select, this)
              : void 0
          );
        }),
        (t.prototype.create_node = function () {
          ...
          return (
            ...
            e.click({ option: this }, function (t) {
